...
public class IcyInputStream extends BufferedInputStream 
    ...
    public IcyInputStream (InputStream in) 
        ...
        if (metaIntTag != null) {
            ...
            try {
                ...
                System.out.println ("Parsed metaint: " +
                                    metaint);
    ...
    protected void readInitialHeaders() throws IOException {
        ...
        while (! ((line = readCRLFLine()).equals(""))) {
            ...
            if (colonIndex == -1)
                continue;
            IcyTag tag = new IcyTag (line.substring (0, colonIndex),
...
StreamTitle='Final Fantasy 8 - Nobuo Uematsu - Blue Fields';StreamUrl='';
    ...
    protected void parseInlineIcyTags (byte[] tagBlock) {
        ...
        StringTokenizer izer =
            new StringTokenizer (blockString,
        ...
        while (izer.hasMoreTokens()) {
            ...
            int valueEndIdx =
                ...
                tagString.length() - 1 : tagString.length();
    ...
    public static void main (String args[]) {
        ...
        try {
            ...
            IcyInputStream icy =
                new IcyInputStream(new BufferedInputStream(conn.getInputStream()));
