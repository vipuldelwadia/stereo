...
public class DatabasePlaylistsTest {
	...
	public void setUp() throws Exception {
		...
		Collection<? extends Track> c = new api.impl.Playlist(1, 2, Collection.EDITABLE, "test", 3, true, 15);
		Collection<? extends Track> d = new api.impl.Playlist(4, 5, Collection.GENERATED, "test2", 6, true, 10);
		...
		output = Playlists.read(r.nextComposite(r.iterator().next()), new api.impl.Playlist.PlaylistFactory());
	}
